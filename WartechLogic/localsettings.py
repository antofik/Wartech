...
DATABASES = {
    'default': {
        ...
        #'NAME': 'wartech.logic',                      # Or path to database file if using sqlite3.
        'USER': 'wartech.logic',                      # Not used with sqlite3.
        'PASSWORD': '',                  # Not used with sqlite3.
        'HOST': 'wartech.logic',                      # Set to empty string for localhost. Not used with sqlite3.
