...
DATABASES = {
    'default': {
        ...
        #'NAME': 'wartech.web',                      # Or path to database file if using sqlite3.
        'USER': 'wartech.web',                      # Not used with sqlite3.
        'PASSWORD': '',                  # Not used with sqlite3.
        'HOST': 'wartech.web',                      # Set to empty string for localhost. Not used with sqlite3.
